  ...
  <v-app style="background: initial">
    ...
    <v-footer color="primary" height="auto">
      <v-layout justify-center row wrap>
        ...
        <v-flex xs12 class="primary lighten-1 py-1 text-xs-center white--text" >
  ...
  data () {
    return {
      ...
      footerLinks: [{
        ...
        action () { open('https://github.com/GLaDOS1105/quizlet-vocabulary/issues') },
        icon: 'bug_report',
        tooltip: '錯誤回報'
      }, {
        action () { open('https://github.com/GLaDOS1105/quizlet-vocabulary') },
        icon: 'code',
        tooltip: 'GitHub'
      }]
    }
